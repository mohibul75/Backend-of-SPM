	...
	if (response.status_code == 200):  
		...
		for x in todos:
			...
			if (response2.status_code == 200):  
				...
				details = x['FullName'] + ", also know by it's trading code "+ companyId +", is one of the leading securities in Dhaka Stock Exchange. This company can be reached at the following contact details - "
